...
<head>
  ...
  <title>Admin | Global Center of Excellence</title>
...
<body>
  ...
  <nav class="navbar navbar-dark sticky-top flex-md-nowrap p-2" style="background:#2471A3;">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0 px-3" href="#"> <img src="../assets/img/logo/logo_w.png" alt="" width="150px"> </a>
